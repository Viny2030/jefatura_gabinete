...
FUENTES = {
    "adjudicaciones_2020": (
        "https://infra.datos.gob.ar/catalog/jgm/dataset/4/distribution/"
        "4.20/download/adjudicaciones-2020.csv"
    ),
    "adjudicaciones_2019": (
        "https://infra.datos.gob.ar/catalog/jgm/dataset/4/distribution/"
        "4.18/download/adjudicaciones-2019.csv"
    ),
    "adjudicaciones_2018": (
        "https://infra.datos.gob.ar/catalog/modernizacion/dataset/2/distribution/"
        "2.15/download/adjudicaciones-2018.csv"
    ),
    "convocatorias_2020": (
        "https://infra.datos.gob.ar/catalog/jgm/dataset/4/distribution/"
        "4.19/download/convocatorias-2020.csv"
    ),
}
...
COLUMNAS_ADJUDICACIONES = {
    # Formato datos.gob.ar 2020+
    "ejercicio": "ejercicio",
    "numero_procedimiento": "nro_proceso",
    "nro_proceso": "nro_proceso",
    "descripcion_saf": "organismo",
    "organismo_contratante": "organismo",
    "tipo_de_procedimiento": "tipo_proceso",
    "tipo_proceso": "tipo_proceso",
    "descripcion_proveedor": "proveedor",
